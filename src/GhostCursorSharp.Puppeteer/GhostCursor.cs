...
public sealed class GhostCursor
{
    ...
    public Task<BoundingBox> GetElementBoxAsync(IElementHandle element, bool relativeToMainFrame = true)
        => GetNativeElementBoxAsync(element, relativeToMainFrame);
    ...
    private static ElementBox ToElementBox(BoundingBox boundingBox)
        => new(
    ...
    private static BoundingBox ToNativeBoundingBox(ElementBox boundingBox)
        => new()
        {
    ...
    private async Task<BoundingBox> GetNativeElementBoxAsync(IElementHandle element, bool relativeToMainFrame)
        => ToNativeBoundingBox(await _geometry.GetElementBoxAsync(Wrap(element), relativeToMainFrame));
