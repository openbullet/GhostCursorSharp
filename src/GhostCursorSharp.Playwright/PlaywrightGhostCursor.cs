...
public sealed class PlaywrightGhostCursor
{
    ...
    public async Task MoveAsync(PlaywrightBoundingBox boundingBox, MoveOptions? options = null)
    {
        ...
        await ExecuteActionAsync(
            async () => await _mover.MoveAsync(ToElementBox(boundingBox), resolvedOptions),
            async () => await GhostCursorTiming.DelayAsync(resolvedOptions.MoveDelay, resolvedOptions.RandomizeMoveDelay));
    }
    ...
    private static ElementBox ToElementBox(PlaywrightBoundingBox boundingBox)
        => new(boundingBox.X, boundingBox.Y, boundingBox.Width, boundingBox.Height);

    private static PlaywrightBoundingBox ToPlaywrightBoundingBox(ElementBox boundingBox)
        => new()
        {
