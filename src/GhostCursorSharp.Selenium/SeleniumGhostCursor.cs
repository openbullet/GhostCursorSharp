...
/// <summary>
/// Moves a Selenium WebDriver mouse along human-like paths generated by <see cref="CursorPath"/>.
/// </summary>
public sealed class SeleniumGhostCursor
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SeleniumGhostCursor"/> class.
    /// </summary>
    /// <param name="driver">The Selenium driver whose mouse will be controlled.</param>
    /// <param name="start">The initial cursor location. Defaults to the origin.</param>
    public SeleniumGhostCursor(IWebDriver driver, Vector? start = null)
        : this(driver, new GhostCursorOptions { Start = start })
    {
    }
    ...
    public SeleniumGhostCursor(IWebDriver driver, GhostCursorOptions? options)
    {
        _driver = driver;
        var pageAdapter = new SeleniumCursorPageAdapter(driver);
        ...
        _geometry = new SeleniumCursorElementGeometry();
    ...
    /// <summary>
    /// Gets the Selenium driver controlled by this cursor.
    /// </summary>
    ...
    /// <returns>A configured <see cref="SeleniumGhostCursor"/> instance.</returns>
    public static SeleniumGhostCursor CreateCursor(
        IWebDriver driver,
        Vector? start = null,
        DefaultOptions? defaultOptions = null,
        bool visible = false)
        => new(driver, new GhostCursorOptions
        {
            Start = start,
    ...
    /// <summary>
    /// Installs the visual mouse helper into the current document.
    /// </summary>
    ...
    public async Task<MouseHelperInstallation> InstallMouseHelperAsync()
    {
        ...
        _mouseHelper = await MouseHelper.InstallAsync(Driver);
        return _mouseHelper;
    }
    ...
    public async Task<IWebElement> GetElementAsync(string selector, GetElementOptions? options = null)
    ...
    public Task<IWebElement> GetElementAsync(IWebElement element, GetElementOptions? options = null)
    {
    ...
    /// When <see langword="true"/>, return coordinates relative to the current Selenium browsing context.
    /// </param>
    /// <returns>The resolved element box.</returns>
    public Task<ElementBox> GetElementBoxAsync(IWebElement element, bool relativeToMainFrame = true)
    ...
    /// <param name="options">Optional scroll settings.</param>
    /// <returns>A task that completes when the element is in view.</returns>
    public Task ScrollIntoViewAsync(IWebElement element, ScrollIntoViewOptions? options = null)
    ...
    /// <summary>
    /// Moves the cursor to a point selected inside the specified element box.
    /// </summary>
    /// <param name="boundingBox">The element box to target.</param>
    /// <param name="options">Optional movement and targeting settings.</param>
    /// <returns>A task that completes when the movement finishes.</returns>
    public async Task MoveAsync(ElementBox boundingBox, MoveOptions? options = null)
    {
    ...
    /// <param name="options">Optional movement and targeting settings.</param>
    /// <returns>A task that completes when the movement finishes.</returns>
    public async Task MoveAsync(IWebElement element, MoveOptions? options = null)
    {
        var resolvedOptions = _optionResolver.ResolveMoveOptions(options);
        await ExecuteActionAsync(
    ...
    /// <param name="options">Optional click settings.</param>
    /// <returns>A task that completes when the click finishes.</returns>
    public async Task ClickAsync(IWebElement element, ClickOptions? options = null)
    {
        var resolvedOptions = _optionResolver.ResolveClickOptions(options);
        await ExecuteActionAsync(async () =>
        {
    ...
    private SeleniumCursorElementHandle Wrap(IWebElement element)
        => new(_driver, element);

    private static IWebElement Unwrap(ICursorElementHandle element)
        => element is INativeCursorElementHandle<IWebElement> nativeElement
            ? nativeElement.NativeElement
            : throw new InvalidOperationException(
                $"The {nameof(SeleniumGhostCursor)} Selenium facade expected a Selenium element adapter.");
